...
// PF_PageHandle: provides access to the contents of a given page. To access
// the contents of a page, a client first creates an instance of this class and
// passes it to one of the PF_FileHandle methods described above.
class PF_PageHandle {
...
// PF_FileHandle: provides access to the pages of an open file. To access the
// pages of a file, a client first creates an instance of this class and passes
// it to the PF_Manager::OpenFile.
class PF_FileHandle {
    friend class PF_FileHandle;
...
// PF_Manager: handles the creation, deletion, opening, and closing of paged
// files, along with the allocation and disposal of scratch pages.
class PF_Manager {
    friend class PF_Manager;
public:
    // Constructor
